...
export const enUS = {
  ...
  plugins: {
    ...
    schedules: {
      ...
      description: "Plugins can register schedules themselves, or you can add one manually. Runs on the assigned desktop while EdgeEver is open.",
      command: "Plugin command",
      chooseCommand: "Choose a command",
      name: "Task name",
      cron: "Cron expression",
      timezone: "Time zone",
      missedRun: "When a run is missed",
      runOnce: "Run once after recovery",
      skip: "Skip it",
      create: "Create schedule",
      created: "Scheduled task created.",
      empty: "No scheduled plugin commands are assigned to this device.",
      noNextRun: "This schedule has no future run.",
      toggle: "Enable or disable {{name}}",
      delete: "Delete {{name}}",
      pluginManaged: "Registered by {{plugin}} · {{key}}",
      history: "Run history",
