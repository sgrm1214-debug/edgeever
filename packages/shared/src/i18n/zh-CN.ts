...
export const zhCN = {
  companion: {
    ...
    "stop": "停止",
    "memoryHelp": "只保存你明确添加的内容，不自动画像。最多 50 条，每条 500 字；可修改或忘记。保存后会重置后续请求的历史上下文。",
    "correct": "纠正",
    "addMemory": "让她记住一件事",
    "forget": "忘记",
    "fromMessage": "来源：你主动保存的对话原话",
    "fromManual": "来源：你手动添加或修改",
    "backupHelp": "预览数据尚未纳入笔记 ZIP 备份，也不支持原生移动端或桌面离线同步。请单独导出；导入只合并记忆、不恢复聊天。导出文件包含明文，请妥善保管。",
    "export": "导出记忆与聊天",
    "import": "导入记忆",
    "clearHistory": "清空聊天记录",
    "useMemory": "使用已保存记忆",
    "allowNotes": "允许搜索我的笔记（只读）",
    "contextHelp": "未勾选笔记权限时不会检索笔记。关闭记忆后，仍可接续本会话中未使用记忆的对话；曾使用记忆或引用笔记的回复不带入。只在发送时调用模型。",
    "message": "想和 EdgeEver 聊些什么？",
    "send": "发送",
    "clearHelp": "删除全部聊天（不可撤销），但保留你保存的记忆，并停止当前生成。可先导出备份。",
    "forgetHelp": "删除这条记忆，停止当前生成，并从后续自动上下文中排除旧回复。已有聊天文本、导出备份及模型服务商的数据不会随之删除；需要时请另行清空。",
    "configureModel": "请先在 AI 设置中配置默认模型，再开始聊天。",
    "conflict": "记忆已被其他操作修改，或超过 50 条上限。请刷新后再试。",
    "historyFull": "已达到 500 条对话上限，请先导出并清空聊天。",
  ...
  plugins: {
    ...
    schedules: {
      title: "插件定时任务",
      description: "插件可以自行注册计划，你也可以手动添加。EdgeEver 在绑定的桌面设备运行时执行。",
      command: "插件命令",
      ...
      create: "创建定时任务",
      created: "定时任务已创建。",
      empty: "当前设备尚未绑定定时插件命令。",
      noNextRun: "这个计划没有下一次执行时间。",
      toggle: "启用或停用 {{name}}",
      delete: "删除 {{name}}",
      pluginManaged: "由插件 {{plugin}} 注册 · {{key}}",
      history: "执行记录",
